...
public extension UINavigationController {
    ...
    var sj_gestureType: SJNavigationPopGestureType {
        get {
    ...
    var sj_transitionMode: SJTransitionMode {
        get {
    ...
    /// pop gesture state.
    var sj_popGestureState: UIGestureRecognizer.State {
        get {
    ...
    var sj_backgroundColor: UIColor? {
        get {
...
public extension UIViewController {
     ...
     **/
    weak var sj_considerWebView: WKWebView? {
        get {
...
extension UINavigationController : UIGestureRecognizerDelegate {
    ...
    @objc private func SJ_handlePanGR(_ pan:UIPanGestureRecognizer) -> Void {
        ...
        case .ended, .cancelled, .failed:
            SJ_ViewDidEndDragging(offset,pan.velocity(in: pan.view))
        @unknown default:
            fatalError()
        }
    }
    ...
    private func SJ_ViewDidEndDragging(_ offset: CGFloat,_ speed :CGPoint = .zero) -> Void {
        ...
        let pop: Bool = abs(speed.x) > 800 ? true : ((rate > maxOffset) == true)
